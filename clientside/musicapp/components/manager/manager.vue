              ...
              <form @submit.prevent="addNewMusic" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="custom-file">
                    <input type="file" id="customFile" ref="file" v-on:change="handleFileUpload()" class="custom-file-input" />
  ...
  methods: {
    ...
    addNewMusic() {
      ...
      if (
        ...
        this.$axios.$post('/music', formData).then(
          response => {
    ...
    deleteMusic(id) {
      swal({
        ...
        if (willDelete) {
          ...
          .then(response => {
            this.getAllMusics()
            swal('Proof! Your Music file has been deleted!', {
              icon: 'success'
            })
          })
          .catch(err => {
