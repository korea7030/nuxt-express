        ...
        <div class="col-md-6">
          ...
          <div class="card player_card">
            <div class="card-body">
              ...
              <div>
                <i class="fa-backward control mr-4" @click="prev"></i>
                <i class="fa-play play" @click="play(current)" v-if="!isplaying"></i>
                <i class="fa-pause play" @click="pause" v-else></i>
                <i class="fa-forward control ml-4" @click="next"></i>
              </div>
            </div>
          </div>
        </div>
